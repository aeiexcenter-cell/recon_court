...
import e015Raw from './evidence/现勘照片.md?raw';
...
// Media imports
// =============================================================================
import imgScene1 from './media/2026-02-09-14-47-15-image.png';
import imgScene2 from './media/2026-02-09-14-47-47-image.png';

// 替换 Markdown 中的图片路径
const e015 = e015Raw
    .replace('/evidence_images/2026-02-09-14-47-15-image.png', imgScene1)
    .replace('/evidence_images/2026-02-09-14-47-47-image.png', imgScene2);

// =============================================================================
// Case meta
// =============================================================================
export const CASE_META: CaseInfo = {
...
// Evidence list
// =============================================================================
export const CASE_EVIDENCE: BackendEvidence[] = [
